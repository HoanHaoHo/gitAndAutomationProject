...
Enemy.prototype.update = function (dt) {
    ...
    if (this.x > 510) {
        // bug reset after go over the board
        this.x = -20;
    }

    if (this.x < player.x + 25 && this.x + 55 > player.x) {
        // collosion between bug and player
    ...
    if (level === 2) {
        // increase speed after player complete each level
        ...
        // highest level of game , I will update new version later
...
var enemy1 = new Enemy(-20, 50, 300);
var enemy2 = new Enemy(-10, 135, 200);
var enemy3 = new Enemy(5, 220, 200);
var enemy4 = new Enemy(50, 300, 500);
var enemy5 = new Enemy(-100, 50, 400);
...
var Engine = function (global) {
   ...
   */
  Resources.load(['images/stone-block.png', 'images/water-block.png', 'images/grass-block.png', 'images/enemy-bug.png', 'images/char-boy.png', 'images/char-cat-girl.png', 'images/char-horn-girl.png', 'images/enemy-bug.png']);
